...
class _TestHacs64(TestWithMPI):
    ...
    def test1(self):
        ...
        instance.initialize_code()
        instance.parameters.eps2 = 0.0 | units.AU**2
    ...
    def test3(self):
        ...
        instance = self.new_instance_of_an_optional_code(
            Hacs64, convert_nbody, **default_options)
        instance.initialize_code()
        instance.parameters.eps2 = 0.00001 | units.AU**2
        instance.dt_dia = 5000
    ...
    def test6(self):
        ...
        self.assertAlmostEqual(0.0 | units.AU**2, instance.parameters.eps2, in_units=units.AU**2)
        for x in [0.01, 0.1, 0.2]:
            instance.parameters.eps2 = x | units.AU**2
            self.assertAlmostEqual(x | units.AU**2, instance.parameters.eps2, in_units=units.AU**2)
    ...
    def test7(self):
        print("Test7: Testing effect of Hacs64 parameter eps2")
        ...
        for log_eps2 in range(-9, 10, 2):
            instance = self.new_instance_of_an_optional_code(
                Hacs64, convert_nbody, **default_options)
            instance.initialize_code()
            instance.parameters.eps2 = 10.0**log_eps2 | units.AU ** 2
            instance.particles.add_particles(particles)
            instance.commit_particles()
            ...
            instance.stop()
        # Small values of eps2 should result in normal earth-sun dynamics: rotation of 90 degrees
        self.assertAlmostEqual(abs(final_direction[0]), abs(initial_direction+math.pi/2.0), 2)
        # Large values of eps2 should result in ~ no interaction
        self.assertAlmostEqual(final_direction[-1], initial_direction, 2)
        # Outcome is most sensitive to eps2 when eps2 = d(earth, sun)^2
    ...
    def test13(self):
        ...
        instance.initialize_code()
        instance.parameters.eps2 = 0.01 | nbody_system.length ** 2
        instance.particles.add_particles(particles)
    ...
    def test14(self):
        instance = self.new_instance_of_an_optional_code(
            Hacs64, **default_options)
        instance.initialize_code()
        instance.parameters.eps2 = 0.00001 | nbody_system.length**2
